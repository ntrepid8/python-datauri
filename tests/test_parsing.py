...
class ParseTestCase(unittest.TestCase):
    ...
    def test_parse_name(self):
        t = ('data:text/plain;name=file-1_final.txt;charset=utf-8;base64,'
             'VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3ZlciB0aGUgbGF6eSBkb2cu')
        parsed = DataURI(t)
    ...
    def test_urlencoded(self):
        t = ("data:text/plain;name=file%201%20('final'!)%20*~.txt;charset=utf-8;base64,"
             "VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3ZlciB0aGUgbGF6eSBkb2cu")
        parsed = DataURI(t)
        self.assertEqual(parsed.name, "file 1 ('final'!) *~.txt")

    def test_parse_name_no_charset(self):
        t = ('data:text/plain;name=file.txt;base64,'
             'VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3ZlciB0aGUgbGF6eSBkb2cu')
        parsed = DataURI(t)
    ...
    def test_wrap(self):
        ...
        self.assertEqual(
            ...
            ('data:text/plain;charset=utf-8;base64,'
             'VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3Z\nlciB0aGUgbGF6eSBkb2cu'))
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(uri),
            ("DataURI('data:text/plain;charset=utf-8;base64,"
             "VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3ZlciB0aGUgbGF6eSBkb2cu')"))
